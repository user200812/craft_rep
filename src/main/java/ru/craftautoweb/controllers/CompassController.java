...
import ru.craftautoweb.validators.CompassFormValidator;

@Controller
public class CompassController extends BaseController {

    // Переменные для определения RequestMapping (должны быть final)
    private static final String C_TYPE_DESC = "compass";
    private static final String C_TYPE_URL = "Compass";
    private static final String C_TYPE_JS = "Compass";
    ...
    @Autowired
    CompassFormValidator itemFormValidator;
    ...
    public String Create(Model model) {
        CompassEntity item = new CompassEntity();
    ...
    public String Edit(@PathVariable int id, Model model) {
        CompassEntity item = CompassEntity.getById(id);
        if (item == null) {
    ...
    public String CreateAction(
            @ModelAttribute(C_TYPE_DESC + "Form") @Validated CompassEntity item,
