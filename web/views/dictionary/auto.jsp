...
<h2>${TypeOp}</h2>
<spring:message code="NotEmpty.autoForm.name" var="NotEmptyname"/>

<form:form class="form-horizontal" method="post"
           modelAttribute="autoForm" action="Directories/${actionUrl}">
...
<div>
    <a href="Directories/Auto" class="btn">Назад к списку</a>
</div>
