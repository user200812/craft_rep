...
<h2>${TypeOp}</h2>
<spring:message code="NotEmpty.routeForm.name" var="NotEmptyname" />

<form:form class="form-horizontal" method="post"
           modelAttribute="tableForm" action="Directories/${actionUrl}">
...
<div>
    <a href="Directories/Tables" class="btn">Назад к списку</a>
</div>
