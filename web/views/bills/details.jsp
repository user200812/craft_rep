...
<h2>Просмотр</h2>
<a class="btn btn-default pull-right" href="Bills/Print/${billdetails.id}" target="_blank">Печать</a>
...
<form:form class="form-horizontal" method="post"
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input value="${billdetails.agencyName}" class="form-control" disabled/>
            </div>
        </div>
        ...
        <table class="table table-hover header-fixed">
            ...
            <c:forEach items="${billdetails.details}" var="item">
                <tr class="onclick" onclick="document.location='Orders/Edit/${item.id}'">
                    <td>
                            ${item.number}
                    </td>
                    <td>
...
<div>
    <a href="Bills/List">Назад к списку</a>
</div>
